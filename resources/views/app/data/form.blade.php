    ...
    <div class="row justify-content-center">
        <div class="col">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ $data ? route('users-update-app', $data->id) : route('users-store-app') }}">
                        @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ $data ? $data->name : '' }}" required autocomplete="name" autofocus>
